...
const Banner = () => {
    return (
      ...
      <div className='bg-[#07332F] py-28 flex items-center justify-between px-16'>
        <div className='text-white w-1/2 '>
           <h2 className='capitalize text-4xl font-bold mb-4 leading-[50px]'>Your best medical <br/> help center </h2>
           <p className='text-[19px] mb-4'>Our service is always good in international area.Because we are always active and helpfull for every patient.In critical patient we always provide extra care & service.we provide our service for minimum price.</p>
